	...
	<div class="row">
		...
		<div class="col-xs-12">
			...
			<div class="row">
				...
				<div class="col-xs-12">
					<div class="info-page-content"><h1>Customer Profile</h1></div>
				</div>
					...
					<div class="row mB24 mobileMB0">
						...
						<div class="col-xs-12 col-sm-7 col-md-8">
							...
							<div class="row user-details">
								...
								<div class="col-xs-12 col-sm-6">
									<p><strong>Address:</strong> Apple Valley, NY</p>
								</div>
								
								<div class="col-xs-12 number-bottom">
				...
				<div class="col-xs-12">					
					<?php include("completed-projects.php"); ?>
